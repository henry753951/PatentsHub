/*
  ...
  - You are about to drop the column `OnTop` on the `PatentManualStatus` table. All the data in the column will be lost.
  - Added the required column `Override` to the `PatentManualStatus` table without a default value. This is not possible if the table is not empty.
