...
const test
   = "◎98.08事務所來函詢問是否申覆。◎98.09進行申覆。◎99.01請事務所領證+1-3年費(9100)。◎99.07申請國科會專利補助(申覆、領證)。◎101.12事務所來函詢問是否續繳4-5年年費@5000元*2。◎101.12.12請事務所繳4-5年費。◎103.請事務所繳第6年年費。◎107.02 請事務所繳第9年年費。◎107.11.27 請老師至研發處開會討論所屬專利維護事宜。◎108.02.22 11/27會議紀錄簽核通過（編號：1080002517)會議決議，如超過六年技轉會不維護，則由老師自行負擔費用，經濟部終止作業，老師說不處理。◎108.03.05第10-11年費用收據轉送黃老師，請他自行支付費用，學校不分攤。◎111.11.07黃師學生林柏辰來電表示都不維護了，之後他要畢業，有問題直接找老師。◎111.12.08發文至國科會申請終止。◎112.04.13國科會來文同意終止維護（科會產字第1120021196號）。◎112.12聖島通知專利權消滅（消滅日期：2023/3/1）◎◎";

const data = parseRecord(test);
console.log(data);
console.log(data.length);

const data2 = parseRecord(test.replaceAll("◎", ""));
console.log(data2);
